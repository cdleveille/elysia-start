...
import { createRootRoute, Outlet, HeadContent, Scripts, createFileRoute, Link, useRouter, useMatch, rootRouteId, ErrorComponent, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
import { TanStackRouterDevtools } from '@tanstack/react-router-devtools';
import { createMemoryHistory } from '@tanstack/history';
import { joinPaths, trimPath, processRouteTree, isRedirect, isResolvedRedirect, isNotFound, rootRouteId as rootRouteId$1, getMatchedRoutes, createControlledPromise, isPlainObject, pick, TSR_DEFERRED_PROMISE, isPlainArray, defer } from '@tanstack/router-core';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DVZNNO1M.mjs');
...
const mainCss = "/assets/main-Bx2TZteV.css";
...
function Home() {
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h3", { children: "Welcome Home!!!" }) });
}
